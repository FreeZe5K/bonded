...
<div class="overflow-hidden py-16 sm:py-24">
  <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
    <div class="max-w-4xl">
      <p class="text-base/7 font-semibold text-indigo-600">About us</p>
      <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-stone-900 sm:text-5xl">
        On a mission to empower remote teams
      </h1>
      <p class="mt-6 text-balance text-xl/8 text-stone-700">
    ...
    <section class="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
      <div class="lg:pr-8">
        <h2 class="text-pretty text-2xl font-semibold tracking-tight text-stone-900">
          Our mission
        </h2>
        <p class="mt-6 text-base/7 text-stone-600">
        ...
        <p class="mt-8 text-base/7 text-stone-600">
      ...
      <div class="max-lg:mt-16 lg:col-span-1">
        <p class="text-base/7 font-semibold text-stone-500">The numbers</p>
        <hr class="mt-6 border-t border-stone-200" />
        <dl class="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
          <div class="flex flex-col gap-y-2 border-b border-dotted border-stone-200 pb-4">
            <dt class="text-sm/6 text-stone-600">Raised</dt>
            <dd class="order-first text-6xl font-semibold tracking-tight">$<span>150</span>M</dd>
          </div>
          <div class="flex flex-col gap-y-2 border-b border-dotted border-stone-200 pb-4">
            <dt class="text-sm/6 text-stone-600">Companies</dt>
            <dd class="order-first text-6xl font-semibold tracking-tight"><span>30</span>K</dd>
          </div>
          <div
            class="flex flex-col gap-y-2 max-sm:border-b max-sm:border-dotted max-sm:border-stone-200 max-sm:pb-4"
          >
            <dt class="text-sm/6 text-stone-600">Deals Closed</dt>
            <dd class="order-first text-6xl font-semibold tracking-tight"><span>1.5</span>M</dd>
          </div>
          <div class="flex flex-col gap-y-2">
            <dt class="text-sm/6 text-stone-600">Leads Generated</dt>
