<div class="py-24 sm:py-32">
  <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
    ...
    <p
      class="mt-2 max-w-lg text-pretty text-4xl font-semibold tracking-tight text-stone-950 sm:text-5xl"
    >
      ...
      <div class="relative lg:col-span-3">
        ...
        >
          ...
          <div class="p-10 pt-4">
            ...
            <p class="mt-2 text-lg font-medium tracking-tight text-stone-950">
              Lightning-fast builds
            </p>
            <p class="mt-2 max-w-lg text-sm/6 text-stone-600">
      ...
      <div class="relative lg:col-span-3">
        ...
        >
          ...
          <div class="p-10 pt-4">
            ...
            <p class="mt-2 text-lg font-medium tracking-tight text-stone-950">Push to deploy</p>
            <p class="mt-2 max-w-lg text-sm/6 text-stone-600">
